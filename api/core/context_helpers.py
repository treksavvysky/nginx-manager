...
class Suggestion:
    ...
    def to_dict(self) -> dict[str, Any]:
        result = {"action": self.action, "reason": self.reason, "priority": self.priority.value}
        if self.endpoint:
...
def get_site_create_suggestions(site_name: str, site_type: str, reloaded: bool, enabled: bool) -> list[dict[str, Any]]:
...
def get_site_update_suggestions(site_name: str, reloaded: bool, changes_made: list[str]) -> list[dict[str, Any]]:
...
def get_site_delete_suggestions(site_name: str, reloaded: bool, was_enabled: bool) -> list[dict[str, Any]]:
...
def get_site_enable_suggestions(site_name: str, reloaded: bool) -> list[dict[str, Any]]:
...
def get_site_disable_suggestions(site_name: str, reloaded: bool) -> list[dict[str, Any]]:
...
def get_nginx_reload_suggestions(success: bool, health_verified: bool, auto_rolled_back: bool) -> list[dict[str, Any]]:
...
def get_nginx_restart_suggestions(success: bool, health_verified: bool) -> list[dict[str, Any]]:
...
def get_system_state_summary(
    nginx_running: bool, nginx_healthy: bool, total_sites: int, enabled_sites: int, disabled_sites: int
) -> dict[str, Any]:
...
def get_cert_request_suggestions(domain: str, reloaded: bool, sites_using_cert: list[str]) -> list[dict[str, Any]]:
...
def get_cert_diagnostic_suggestions(
    domain: str, dns_ok: bool, port_80_ok: bool, has_cert: bool
) -> list[dict[str, Any]]:
...
def get_error_context(
    error_type: str, error_message: str, operation: str, resource: str | None = None
) -> dict[str, Any]:
    """Generate rich error context for AI agents."""
    context = {"error_type": error_type, "message": error_message, "operation": operation}
